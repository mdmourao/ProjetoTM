...
class Client implements Runnable {
    ...
    @Override
    public void run() {
        System.out.println("A enviar dinheiro... Aguarde!");
        ...
        if (r.getStatus() == Response.Status.OK.getStatusCode() && r.hasEntity())
            System.out.println("Success, updated amount with Nodeid: " + r.readEntity(String.class));
        else
...
public class NodeClientServer {
    public static void main(String[] args) throws IOException {
        //Criar servidor que está sempre disponivel
        Server s = new Server();
        s.run();
